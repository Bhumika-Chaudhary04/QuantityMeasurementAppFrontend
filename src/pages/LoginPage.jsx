...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    const rememberChoice = sessionStorage.getItem("quanmentRememberChoice");
const rememberMe = rememberChoice === "local";
storeAuthSession(token, name || "User", userEmail || "", rememberMe);
sessionStorage.removeItem("quanmentRememberChoice");
